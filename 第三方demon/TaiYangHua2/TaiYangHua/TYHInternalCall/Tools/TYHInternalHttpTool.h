...
@interface TYHInternalHttpTool : NSObject
...
+ (void)uploadImageWithParams:(NSDictionary *)params
             imageSession:(TYHInternalSession *)imageSession
...
+ (void)uploadVoiceWithParams:(NSDictionary *)params
                voiceSession:(TYHInternalSession *)voiceSession
                      success:(void (^)(id json))success
                     progress:(void (^)(CGFloat progress))progress
                      failure:(void (^)(NSError *error))failure;
 ...
 *  @param failure 失败
 */
+ (void)sendGroupChatWithParam:(NSDictionary *)param
                       session:(TYHInternalSession *)session
                       success:(void (^)(id json))success
                       failure:(void (^)(NSError *error))failure;
 ...
 *
 */
+ (void)findNewSessionMsgsWithparams:(NSDictionary *)params
                       targetType:(NSInteger)targetType
                completionHandler:(void (^)(id json))handler;

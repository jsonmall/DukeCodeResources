...
- (void)clickSelectedButton:(UIButton *)selectedButton
{
    ...
    if ([self.delegate respondsToSelector:@selector(internalAssetGridCell:didClickButton:)]) {
        [self.delegate internalAssetGridCell:self didClickButton:selectedButton];
    }
}

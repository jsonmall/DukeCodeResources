...
//    NSMutableDictionary *dict = [NSMutableDictionary dictionary];
    ...
    if ([self.delegate respondsToSelector:@selector(internalSessionEmotionCell:didClickEmotion:)]) {
        [self.delegate internalSessionEmotionCell:self didClickEmotion:emotion];
    }

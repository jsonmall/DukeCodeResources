...
+ (NSMutableAttributedString *)tipStringWhileSearch:(NSInteger)foundDeviceNumber;

+ (NSString *)roomAndFloorNameWithUID:(NSString *)UID roomID:(NSString *)roomID;
 ...
 *  @return RGB
 */
+ (UIColor *)colorTemperatureToRGB:(float)temperature;

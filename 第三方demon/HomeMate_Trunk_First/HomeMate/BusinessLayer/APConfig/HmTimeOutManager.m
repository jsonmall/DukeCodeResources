...
#import "HmTimeOutManager.h"

static HmTimeOutManager * manager = nil;

@interface HmTimeOutManager ()
...
@implementation HmTimeOutManager
...
-(NSTimeInterval)removeMsg:(VhAPConfigMsg *)sipMsg
{
    // 移除该监视点 并计算响应时间
...
// 在主线程执行超时回调动作
-(void)performTimeoutOnMainThreadWithSipMsg:(VhAPConfigMsg *)msg
{

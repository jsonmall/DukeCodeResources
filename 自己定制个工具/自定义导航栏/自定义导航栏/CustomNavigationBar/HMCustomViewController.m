...
- (void)viewDidLoad
{
    ...
    _viewNaviBar = [[HMCustomNaviBarView alloc] initWithFrame:Rect(0.0f, 0.0f, [HMCustomNaviBarView barSize].width, 64*_VProportionScale)];
    _viewNaviBar.m_viewCtrlParent = self;
    [self.view addSubview:_viewNaviBar];
    if ((int)_VProportionScale == 1) {
       [_viewNaviBar setTitleLabelFrame:Rect(65.0f*HProportion, 20.0f, 190.0f*HProportion, 44.0f)];
    }

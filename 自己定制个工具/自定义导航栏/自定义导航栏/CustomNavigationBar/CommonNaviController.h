 ...
 *  @param type 导航栏的类型
 */
-(void)customizeNaviBarForDictionary:(NSDictionary *)dic barType:(NaviBarType)type backgroundColor:(UIColor*)backgroundcolor;
 ...
 *  导航栏底部增加线条
 */
-(void)setNaviBarLineWithColor:(UIColor*)color;
